...
| Current tranche | Stack-map and reference-architecture coherence complete; next recommended content tranche is build-vs-buy follow-through and reference cleanup (`18`) |
| Last completed pass ID | `2026-04-18.e` |
| Current recommendation | `advance to G-11` |

## Workstream Board

| Workstream | Status | Active gap IDs | Done when |
| --- | --- | --- | --- |
| `WS1` Reduce Boilerplate And Repetition | Active | `G-01`, `G-05`, `G-06`, `G-08`, `G-09`, `G-10`, `G-11`, `G-12`, `G-13` | chapter and section front doors are concise across the remaining weak clusters |
| `WS2` Increase Information Density And Asymmetry | Active | `G-01`, `G-05`, `G-06`, `G-07`, `G-08`, `G-09`, `G-10`, `G-11`, `G-12`, `G-13` | remaining thin pages are strengthened, merged, or explicitly deferred |
...
| `WS9` Strengthen High-Leverage Chapters First | Active | `G-05`, `G-06`, `G-07`, `G-08`, `G-09`, `G-11`, `G-12` | the highest-judgment chapters no longer read like scaffold material |
...
1. `G-11` Build-vs-buy follow-through and reference cleanup
2. `G-12` Standards and bodies system completion
3. `G-08` Knowledge retrieval and adaptation decision surfaces
4. `G-09` Assurance, observability, and security hardening
5. `G-05` Use-case portfolio density and asymmetry cleanup
6. `G-06` Model, hosting, and gateway stack refinement
7. `G-10` Human oversight operating model completion
8. `G-01` Scope and principles orientation surfaces
9. `G-13` Research and open-knowledge completion
