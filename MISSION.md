...
Cover applied organizational AI and ML broadly, including chat systems, copilots, coding assistants, coding agents, workflow agents, document intelligence, retrieval, memory, forecasting, recommenders, anomaly detection, optimization, computer vision, speech, classical ML, deep learning, generative AI, hybrid systems, fine-tuning, and training systems.
...
Do not turn the atlas into:

- a generic link dump
- hype or marketing copy
- an LLM-only repository
- mixed categories without taxonomy
- duplicate topic files across root and `docs/`, except for this mission
- temporary scaffolding or internal planning artifacts in the public repo unless intentionally retained
