...
| 2026-04-19 | Added tracked Ralph example prompt/profile fixtures, established explicit PIP `pip-status` frontmatter, and closed the non-`docs/` repo consistency gaps captured in `GAP_FIX_PROPOSALS.md`. |
