...
| Control | Purpose |
| --- | --- |
| Route policy | Chooses permitted providers and models |
| Identity integration | Ties requests to roles and services |
| Budget and quota policy | Controls spend |
| Audit logging | Supports incident analysis and governance |

## Artifacts

| Artifact | Purpose |
| --- | --- |
| Gateway policy catalog | Documents central rules |
| Route matrix | Maps use cases to approved routes |
| Cost report | Supports chargeback or review |
