...
| Artifact | Purpose |
| --- | --- |
| RACI or responsibility map | Clarifies who owns what |
| Approval matrix | Maps actions and changes to approvers |
| Review cadence | Keeps oversight regular |
| Incident role card | Defines who responds first |
