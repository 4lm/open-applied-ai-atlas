...
| Control | Purpose |
| --- | --- |
| Least privilege | Bound tool and data access |
| Sandboxing | Limit execution damage |
| Approval checkpoints | Protect high-impact actions |
| Abuse telemetry | Detect misuse patterns |

## Artifacts

| Artifact | Purpose |
| --- | --- |
| Threat model | Captures architecture-specific risks |
| Abuse test pack | Exercises adversarial scenarios |
| Incident playbook | Defines security response flow |
