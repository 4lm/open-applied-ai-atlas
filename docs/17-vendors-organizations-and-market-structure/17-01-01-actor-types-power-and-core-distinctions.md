...
| Ecosystem lens | What it reveals |
| --- | --- |
| Actor type | Separates vendors, foundations, research labs, and integrators |
| Control point | Shows where pricing, hosting, hardware, or ecosystem dependence really sits |
| Dependence mode | Distinguishes people, platform, contract, and data lock-in |
| Stewardship posture | Highlights when openness, neutrality, or support maturity actually matter |

## What Matters Most

- Strategic dependence sits with organizations as well as with interfaces
- Ecosystem control points can matter more than any one tool
- Openness posture and concentration risk are related but not identical
- Talent and integrator dependence deserve the same attention as product dependence
