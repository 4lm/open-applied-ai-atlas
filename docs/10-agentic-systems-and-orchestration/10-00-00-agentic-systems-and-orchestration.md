...
- which approvals, rollback paths, and traces are required before broader deployment
- when a team should step back from agent ambition and redesign the operating model instead
