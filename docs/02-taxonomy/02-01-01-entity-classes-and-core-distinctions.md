...
| Taxonomy layer | Why it exists |
| --- | --- |
| Entity class | Prevents vendors, tools, standards, and model families from being compared as if they were the same thing |
| Cross-cutting dimensions | Makes openness, sovereignty, and portability visible across chapters |
| Risk and oversight | Keeps governance implications close to technical choices |
| Public tiering | Gives readers a summary signal while preserving the underlying reasoning |
...
- Public-facing tiers summarize but do not replace the underlying scorecard
