...
- Product and business path: `1 -> 5 -> 18 -> 4 -> 16`
- Architecture path: `1 -> 2 -> 3 -> 7/8/9/19`
- Data and ML path: `1 -> 2 -> 5 -> 11 -> 12 -> 13`
- Privacy, security, and GRC path: `1 -> 4 -> 6 -> 13 -> 15 -> 20`
- Procurement and leadership path: `1 -> 3 -> 17 -> 18 -> 20`

## Coordination Heuristic

If different roles are reading different chapters, they should explicitly reconcile on taxonomy, use-case class, sovereignty posture, and sourcing assumptions before committing to a stack or vendor path.

## Shared Checkpoints

| Before convergence | Confirm together |
| --- | --- |
| Before architecture selection | the use-case family and operating constraints |
| Before vendor or platform comparison | the portability, sovereignty, and data-boundary posture |
| Before rollout | the evaluation, oversight, and incident model |
